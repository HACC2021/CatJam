      ...
      <div className='tutorial-background'>
        <Container>
          ...
          <Message centered textAlign='center'>
            <p><Icon name='angle right'></Icon>This is the navigation bar. Clicking on elements in the bar allows you to move to other pages in the application.</p>
          </Message>
          ...
          <Message centered textAlign='center'>
            ...
            <p><Icon name='angle right'></Icon>Above is the chatbot page. This is where you will be asking the chatbot questions and receiving answers. If you have an inquiry, it can be sent to the chatbot through text or voice by typing words into the text-box on the bottom, or clicking on the mic symbol on the bottom right of the chatbot window respectively.</p>
          </Message>
          <Image src='images/question.png' size='huge'/>
          <Message>
            <p><Icon name='angle right'></Icon>After asking a question the text will be displayed inside a message on the left side of the screen. Then the chatbot will send a response contained in a message on the right side of the screen.</p>
          </Message>
          <Image src='images/message1.png' size='huge'/>
          <Message>
            <p><Icon name='angle right'></Icon>If you need to contact OHA for any reason, their phone and email contacts are available via the buttons below the chatbot. A link to the OHA official website is also provided.</p>
          </Message>
          ...
          <Message>
            {/* eslint-disable-next-line max-len */}
            <p><Icon name='angle right'></Icon>This is the Send Feedback page. This page allows users to send feedback regarding the chatbot or website. In order to send in feedback the user must fill out their contact details, a name for the input, select what type of feedback they are sending in, and provide a description of their feedback.</p>
          </Message>
          <Image src='images/feedbackP.png' size='huge'/>
          <Message>
            <p><Icon name='angle right'></Icon>When you are done filling out all the fields press the submit button and your feedback will be recorded for staff to look at and consider.</p>
          </Message>
